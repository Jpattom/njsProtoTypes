...
const ledRed = new Gpio(5, { mode: Gpio.OUTPUT }); //use GPIO pin 4 as output for RED
const ledGreen = new Gpio(6, { mode: Gpio.OUTPUT }); //use GPIO pin 17 as output for GREEN
const ledBlue = new Gpio(16, { mode: Gpio.OUTPUT }); //use GPIO pin 27 as output for BLUE
